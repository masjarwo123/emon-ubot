...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/masjarwo123/emon-ubot")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "emon-ubot")
...
IG_ALIVE = os.environ.get("IG_ALIVE") or "instagram.com/diiyyo2808"
...
BOTLOG_MSG = os.environ.get(
    "BOTLOG_MSG") or "```║☻︎ᴇᴍᴏɴ-ᴜʙᴏᴛ☻︎ TELAH AKTIF!!🔥🔥║\n\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nJika Tidak Bisa Di .ping\nSilahkan Anda\nCek viewlogs\nPada heroku Anda.\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰```"
